...
typedef enum : NSUInteger {
    ...
    LDOTimeUnitToday,
    LDOTimeUnitSameDay,
    LDOTimeUnitYesterday,
    LDOTimeUnitPreviousDay,
    LDOTimeUnitTomorrow,
    LDOTimeUnitNextDay,
    ...
    LDOTimeUnitSameWeek,
    LDOTimeUnitLastWeek,
    LDOTimeUnitPreviousWeek,
    LDOTimeUnitNextWeek,
    
    LDOTimeUnitThisMonth,
    LDOTimeUnitLastMonth,
    LDOTimeUnitNextMonth,
...
@interface LDOConditionalDateFormatter : NSFormatter

/**
 Specifies the locale used to format strings.
 This is just a convenience proxy method to access the locale of the `calendar`.
 */
@property (copy, nonatomic) NSLocale *locale;

/**
 Specifies the time zone used to format strings.
 This is just a convenience proxy method to access the time zone of the `calendar`.
 */
...
/**
 ...
 The time unit needs to be a relative time unit like `LDOTimeUnitToday`, `LDOTimeUnitSameWeek` or `LDOTimeNextYear`.
...
/**
 ...
 The time unit should be one of the following: `LDOTimeUnitDays`, `LDOTimeUnitWeeks`, `LDOTimeUnitMonths`, `LDOTimeUnitYears`.
