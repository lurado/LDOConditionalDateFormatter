...
- (void)testQuickStart
{
    ...
    NSDate *twoWeeksAgo = [self parseDate:@"2015-02-11 15:55:00 +0000"];
    ...
    result = [self.formatter stringForTimeIntervalFromDate:twoWeeksAgo toReferenceDate:now];        // 2/11/2015
